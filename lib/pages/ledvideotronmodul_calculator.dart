...
import 'package:flutter_route_name/component/customgmodul.dart';
...
class _LedVideotronModulCalculatorState
  ...
  List<String> listcabwidth = <String>[
    '480',
    '500',
    '640',
    '960',
  ...
  List<String> listcabheight = <String>[
    '480',
    '500',
    '640',
    '960',
  ...
  cabinetcalculator(double pitch) {
    ...
    heightcab = int.tryParse(dropdownValueHeight) ?? 0;
    widthcab = int.tryParse(dropdownValueWidth) ?? 0;
    ...
    modulcount = widthcabcount * heightcabcount;
